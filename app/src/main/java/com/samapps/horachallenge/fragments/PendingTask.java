 ...
 */
public class PendingTask extends Fragment implements MyItemRecyclerViewAdapter.OnListFragmentInteractionListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewAdapter = new
                MyItemRecyclerViewAdapter(adsList, PendingTask.this);
