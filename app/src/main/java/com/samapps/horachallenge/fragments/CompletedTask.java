 ...
 */
public class CompletedTask extends Fragment implements MyItemRecyclerViewAdapter.OnListFragmentInteractionListener{
    ...
    public static CompletedTask newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewAdapter = new
                MyItemRecyclerViewAdapter(adsList, CompletedTask.this);
    ...
    void getPendingTasks(){
        dbRef.orderByChild("assignedTo").equalTo(FirebaseAuth.getInstance().getCurrentUser().getEmail()).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                adsList.clear();
                for (DataSnapshot adSnapshot: dataSnapshot.getChildren()) {
                    Log.e(TAG,"value "+adSnapshot.getValue(Task.class).getName());
                    if (adSnapshot.getValue(Task.class).getIsCompleted())
